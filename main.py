...
def cadastro():
    ...
    if subId is not None:
        ...
        if existing_user:
            ...
            cursor = connect_BD.cursor()
            cursor.execute(
                "INSERT INTO usuarios VALUES (default, %s, %s, %s, default, default, default, '', default, %s, default, default, default, default);",
